    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_name', models.CharField(max_length=50, verbose_name='Kurzname')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrator'), ('commander', 'Zugführer'), ('leader', 'Gruppenführer'), ('member', 'Mitglied')], default='member', max_length=20, verbose_name='Rolle')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('create', 'Erstellt'), ('update', 'Geändert'), ('delete', 'Gelöscht'), ('override', 'Übersteuert')], max_length=20, verbose_name='Aktion')),
                ...
                ('object_repr', models.CharField(max_length=255, verbose_name='Objektbeschreibung')),
